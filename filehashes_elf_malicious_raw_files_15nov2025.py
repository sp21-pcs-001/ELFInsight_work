        ...
        for path in root_dir:
            if path.is_file():
                ...
                if path.name.endswith(".elf"):
                    file = "/home/cyberlab/Documents/15nov2025_improvded_extraction_malware/testing_malicious_elf_arm/elf_compiled/" + ""+path.name
                    ...
                    file_exe = "/home/cyberlab/Documents/15nov2025_improvded_extraction_malware/testing_malicious_elf_arm/elf_compiled" + \
                   ...
                   # extract_command = '"C:\\IDA 7.0\\ida64.exe" -B -c -A -S"C:\\function_features.py"' + " " +  '"' + "C:\\Binary\\" +  path.name + '"'
                    ...
                    if ignore:
                        extract_command = '/usr/bin/wine /root/.wine/drive_c/Program\ Files/IDA\ 7.0/ida64.exe -B -c -A -S"/home/cyberlab/Documents/15nov2025_improvded_extraction_malware/testing_malicious_elf_arm/cmplt_elf_malicious.py"' + \
                            " " + '"' + "/home/cyberlab/Documents/15nov2025_improvded_extraction_malware/testing_malicious_elf_arm/elf_compiled/" + path.name + '"'
