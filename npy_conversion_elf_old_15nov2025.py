        ...
        for path in root_dir:
            if path.is_file():
                if path.name.endswith(".exe.txt"): 
                    i += 1
                    fn = "/home/deepreflect/Desktop/testing_malicious_elf_arm/elf_compiled/" +  path.name
                    ##fn = "C:\\Binary\\Train extract raw\\" +  path.name
                    #output = "C:\\Binary\\Train extract raw npy\\" +  path.name
                    output = "/home/deepreflect/Desktop/testing_malicious_elf_arm/elf_compiled/" +  path.name
                    temp = "/home/deepreflect/Desktop/testing_malicious_elf_arm/elf_compiled/" +  path.name + ".npy"
                    print ("----------------TEMP------------------")
                    print (temp)
                    print ("\n")
