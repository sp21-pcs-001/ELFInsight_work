        ...
        for path in root_dir:
            if path.is_file():
                ...
                if path.name.endswith(".elf"):
                    ...
                    file_exe = "/home/deepreflect/Desktop/testing_malicious_elf_arm/elf_compiled/" +""+digest+".exe_function.txt" 
                    #for function
                   ...
                   # extract_command = '"C:\\IDA 7.0\\ida64.exe" -B -c -A -S"C:\\function_features.py"' + " " +  '"' + "C:\\Binary\\" +  path.name + '"'
                    ...
                    if ignore:
                        ...
                        #extract_command = '/usr/bin/wine /root/.wine/drive_c/Program\ Files/IDA\ 7.0/ida64.exe -B -c -A -S"/home/deepreflect/Desktop/cmplt_elf_malicious.py"' + \
                         ...
                         ##for function
                        extract_command = '/usr/bin/wine /root/.wine/drive_c/Program\ Files/IDA\ 7.0/ida64.exe -B -c -A -S"/home/deepreflect/Desktop/testing_malicious_elf_arm/function_features_elf_malicious.py"' + \
